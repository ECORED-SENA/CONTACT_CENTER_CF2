    ...
    .row.bg-color3.px-5
      .col-12
        figure.mb-5(data-aos="fade-left")
          img(src='@/assets/curso/img26.svg', style="width: 1150px").m-auto
        .tarjeta.color-acento-contenido.p-4.p-md-5(data-aos="fade-right")
